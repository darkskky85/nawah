...
window.NEWS_DATA = {
 "updated": "2026-08-09T04:08:59.142871+00:00",
 "items": [
  {
  ...
  {
   "title": "خبراء الصحة يحذرون من عمليات احتيال تستخدم طبيباً ذكياً مزيفاً",
   "summary": "حذر متخصصون صحيون من ظهور عمليات احتيال تعتمد على نماذج ذكاء اصطناعي تحاكي الأطباء لخداع المرضى. حددوا علامات تحذيرية تساعد الجمهور على التمييز بين الاستشارات الطبية الحقيقية والمزيفة.",
   "url": "https://news.google.?oc=5",
   "source": "Google News — ذكاء اصطناعي",
   "tag": "ذكاء اصطناعي",
   "date": "2026-08-09"
  },
  {
   "title": "مركز بيانات أمازون المخطط قد يصبح أكبر مصدر تلوث مناخي في أمريكا",
   "summary": "تستثمر أمازون في محطة توليد كهرباء ملحقة بمركز بيانات جديد في تكساس قد يصبح أكبر مصدر انبعاثات غازات دفيئة في البلاد. يثير المشروع مخاوف بيئية من تأثيره على المناخ والاستدامة.",
  ...
  {
   "title": "أوبنإيه تستحوذ على شركة NextSlide المتخصصة في العروض التقديمية",
   "summary": "استقطبت أوبنإيه شركة NextSlide وفريقها للعمل على تطوير تطبيقات ChatGPT. تعكس الخطوة توسع الشركة في دمج تقنيات الذكاء الاصطناعي في منتجات إنتاجية متعددة.",
  ...
  {
   "title": "محطة الكهرباء بمركز بيانات أمازون قد تكون الأكثر تلويثاً في أمريكا",
   "summary": "ستبني أمازون محطة غاز طبيعي جديدة في مقاطعة بيكوس بتكساس لتشغيل مركز البيانات الغربي، وقد تصبح واحدة من أكبر مصادر انبعاثات الغازات الدفيئة في الدولة. اجتذب المشروع استثمارات كبيرة لكنه يواجه انتقادات بيئية.",
  ...
  {
   "title": "تنظيم الذكاء الاصطناعي يجب أن يبدأ الآن قبل فوات الأوان",
   "summary": "يؤكد صوت رأي على ضرورة وضع قوانين صارمة لتنظيم تكنولوجيا الذكاء الاصطناعي في المرحلة الحالية. يحذر من أن تأخير التنظيم قد يؤدي إلى مخاطر لاحقة يصعب السيطرة عليها.",
  ...
  {
   "title": "مقارنة الاتجاهات الإيرادية بين آيونكيو وميتا في مجالات الحوسبة الكمية والذكاء الاصطناعي",
   "summary": "يقدم تحليل مقارن لأداء إيرادات شركة آيونكيو المتخصصة في الحوسبة الكمية مع ميتا العملاقة في مجال الذكاء الاصطناعي. يسلط الضوء على اتجاهات نمو كلا القطاعين التكنولوجيين المتنافسين.",
  ...
  {
   "title": "أوبنإيه تستحوذ على شركة إنشاء العروض التقديمية نكست سلايد",
   "summary": "استحوذت أوبنإيه على شركة ناشئة متخصصة في تطوير أدوات إنشاء العروض التقديمية. تأتي هذه الخطوة كجزء من استراتيجية الشركة لتوسيع خدماتها وتطبيقاتها المدفوعة بتقنية الذكاء الاصطناعي.",
   "url": "https://news.google.com/rss/articles/CBMiiAFBVV95cUxQb0ZQNkkzNmZqS00yNkN4LUtIbGxzSEI2ZzYzek5kWk5RNnVWWHc1djE4cXRGdkU2N0Rha3VySlZTRE0yZTZFY1M0UFFBcVBFS2V6MVBuT2U2Q21LX0pjQS1uYk9TWnNiaHRPeXpDNm9zdHZDa1ZPUHp2SlVKZ0s3Y1FQWXpJVjlJ?oc=5",
