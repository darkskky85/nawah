...
window.NEWS_DATA = {
 ...
 "items": [
  ...
  {
   "title": "الولايات المتحدة تشكك في وجود معدات ASML المتقدمة في الصين",
   "summary": "أثارت الحكومة الأمريكية مخاوف حول وجود أدوات تصنيع رقائق متطورة من ASML قد تكون في الصين، لكن الشركة الهولندية نفت هذه الادعاءات. تطرح المسألة تساؤلات حول كيفية عمل تدابير التحكم في الصادرات.",
